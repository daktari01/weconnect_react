    ...
    <div className="col-md-4">
        <div className="white-bg search_item shadow p-3 mb-5 rounded">
            ...
            <dl>
                ...
                <dt>Website:</dt> <dd><a href={business.web_address}>{business.web_address}</a></dd>
            </dl>
            <Link to={"business/"+business.id} className="btn btn-primary review-button">Manage Business</Link>
        </div>
    </div>
)
